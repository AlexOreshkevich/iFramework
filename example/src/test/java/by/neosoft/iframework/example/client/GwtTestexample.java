 ...
 * 
 * If you run the tests using the Maven command line, you will have to navigate with your browser to a
 * specific url given by Maven. See http://mojo.codehaus.org/gwt-maven-plugin/user-guide/testing.html for
 * details.
 */
public class GwtTestexample extends GWTTestCase {
  ...
  public String getModuleName() {
    return "by.neosoft.iframework.example.exampleJUnit";
  }
  ...
  /**
   * This test will send a request to the server using the greetServer method in GreetingService and verify
   * the response.
   */
